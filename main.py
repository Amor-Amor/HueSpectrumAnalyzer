...
class AudioBar:
    ...
    def __init__(self, x, y, freq, color, min_brightness=10,
                 max_brightness=100, min_decibel=-80, max_decibel=0):
        ...
        self.__decibel_height_ratio = (self.max_brightness -
                                       self.min_brightness)/(self.max_decibel -
                                                             self.min_decibel)
    ...
    def update(self, dt, decibel):
        ...
        self.brightness = clamp(self.min_brightness, self.max_brightness,
                                self.brightness)
...
for c in frequencies:
    bars.append(AudioBar(x, 300, c, (255, 0, 0), max_brightness=400))
